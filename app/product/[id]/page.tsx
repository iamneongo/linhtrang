...
import { ArrowLeft, ShoppingBag, Check, Copy } from 'lucide-react';
...
export default function ProductDetailPage() {
  ...
  for (const catId in productsByCategoryId) {
    const found = productsByCategoryId[catId].find((p) => p.id === prodId);
    if (found) {
      product = found;
      break;
    }
    ...
    <div className="min-h-screen bg-[#245B4A] text-white font-sans overflow-x-hidden antialiased flex flex-col">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-28 mt-8 flex-1 w-full">
        ...
        <div className="mb-8">
          ...
          >
            <ArrowLeft className="w-3.5 h-3.5 group-hover:-translate-x-1 transition-transform" /> Quay lại danh sách
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start mb-24">
          ...
          {/* Column 1: Image container (5 cols) */}
          ...
          <div className="lg:col-span-7 flex flex-col">
            ...
            <div className="space-y-3 bg-[#327863]/35 p-5 rounded-2xl border border-white/10 mb-8 text-xs md:text-sm max-w-xl shadow-inner">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-primary-red font-bold">Theo khối lượng dự án (Liên hệ)</span>
              </div>
            </div>
