...
import { HelpCircle, ChevronDown, ShieldCheck, Truck, Sparkles, MessageCircle, Phone } from 'lucide-react';
...
export default function FAQPage() {
  ...
  const faqs: FAQItem[] = [
    ...
    {
      category: 'product',
      question: 'Linh Trang Home có cung cấp dịch vụ thiết kế nội thất 3D miễn phí không?',
      answer: 'Có! Đội ngũ kiến trúc sư và chuyên gia thiết kế của Linh Trang Home cung cấp dịch vụ tư vấn thiết kế 3D miễn phí cho tất cả khách hàng có nhu cầu. Bạn chỉ cần để lại thông tin hoặc liên hệ hotline để đặt lịch khảo sát thực tế và nhận bản vẽ 3D chi tiết.',
    },
    {
      category: 'general',
      question: 'Linh Trang Home có showroom trực tiếp để tham quan mẫu sản phẩm không?',
      answer: 'Linh Trang Home có showroom trưng bày hơn 1000 mẫu sản phẩm tại Đà Lạt, Lâm Đồng. Tại đây, bạn có thể trực tiếp chiêm ngưỡng và trải nghiệm các bộ sưu tập gạch ốp lát tinh thạch, thiết bị vệ sinh mạ PVD và nội thất châu Âu cao cấp. Mời bạn ghé thăm trong giờ hành chính từ 8:00 đến 18:00 hàng ngày.',
    },
  ];
  ...
  const toggleFAQ = (i: number) => setActiveIndex(activeIndex === i ? null : i);
  ...
  return (
    <div className="min-h-screen bg-[#245B4A] text-white font-sans overflow-x-hidden antialiased flex flex-col">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8">
          ...
          >
            ...
            <h1 className="font-headline text-4xl md:text-6xl font-black text-white uppercase tracking-tight leading-none mb-6">
              GIẢI ĐÁP<br />
              <span className="text-primary-red">THẮC MẮC</span>
            </h1>
      ...
      {/* FAQ Content */}
      <section className="py-24 bg-[#245B4A] relative overflow-hidden border-t border-white/5">
        <div className="absolute top-1/4 left-1/10 w-96 h-96 bg-[#E50914]/5 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-1/4 right-1/10 w-96 h-96 bg-[#005BBB]/5 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8 relative z-10">
                ...
                <button
                  ...
                  className={`px-5 py-3 rounded-full text-xs font-headline font-semibold flex items-center gap-2.5 transition-all duration-300 border cursor-pointer ${
                    isActive
                      ...
                      : 'bg-[#327863]/20 text-white/60 border-white/5 hover:border-white/15 hover:text-white'
                  }`}
                >
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="p-1.5 rounded-lg bg-white/5 border border-white/10 text-white/60">
                        <ChevronDown
                    ...
                    <AnimatePresence initial={false}>
                      {isOpen && (
                        ...
                        >
                          <div className="px-6 pb-5 pt-1 text-sm text-white/60 border-t border-white/5 bg-[#327863]/10 leading-relaxed font-normal">
                            {faq.answer}
                          </div>
                        </motion.div>
                      )}
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              <a
                href="tel:0977247623"
                className="px-6 py-3 bg-primary-red hover:bg-[#c0000c] text-white text-xs font-headline font-bold uppercase tracking-wider rounded-xl text-center transition-all duration-300 shadow-md shadow-primary-red/15 flex items-center gap-2 justify-center"
              >
              ...
              <button
                ...
                className="px-6 py-3 bg-white/5 border border-white/10 hover:bg-white/10 text-white text-xs font-headline font-bold uppercase tracking-wider rounded-xl text-center transition-all duration-300"
              >
                Gửi câu hỏi
              </button>
            </div>
