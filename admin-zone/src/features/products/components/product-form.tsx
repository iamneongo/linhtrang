...
import { useAppForm, useFormFields } from '@admin/components/ui/tanstack-form';
...
import { productSchema, type ProductFormValues } from '@admin/features/products/schemas/product';
import { categoryOptions } from '@admin/features/products/constants/product-options';
